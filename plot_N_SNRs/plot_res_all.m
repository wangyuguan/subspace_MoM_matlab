...
res2_all(1,1) = res2_1e4(1);
res2_all(1,2) = res2_1e4(2);
res2_all(1,3) = res2_1e4(3);
res2_all(2,1) = res2_1e5(1);
res2_all(2,2) = res2_1e5(2);
res2_all(2,3) = res2_1e5(3);
res2_all(3,1) = res2_1e6(1);
res2_all(3,2) = res2_1e6(2);
res2_all(3,3) = res2_1e6(3);


res3_all(1,1) = res3_1e4(1);
res3_all(1,2) = res3_1e4(2);
res3_all(1,3) = res3_1e4(3);
res3_all(2,1) = res3_1e5(1);
res3_all(2,2) = res3_1e5(2);
res3_all(2,3) = res3_1e5(3);
res3_all(3,1) = res3_1e6(1);
res3_all(3,2) = res3_1e6(2);
res3_all(3,3) = res3_1e6(3);
...
figure 
semilogx(N, res2_all(1:3,1), '-*', 'LineWidth', 2)
hold on 
semilogx(N, res2_all(1:3,2), '-o', 'LineWidth', 2)
grid on 
semilogx(N, res2_all(1:3,3), '-+', 'LineWidth', 2)
grid on
set(gca,'fontsize',20)
xlabel('$N$','Interpreter','latex', 'FontSize', 30)
ylabel('Resolutions($\textup{\AA}$)','Interpreter','latex', 'FontSize', 30)
...
figure 
semilogx(N, res3_all(1:3,1), '-*', 'LineWidth', 2)
hold on 
semilogx(N, res3_all(1:3,2), '-o', 'LineWidth', 2)
hold on 
semilogx(N, res3_all(1:3,3), '-+', 'LineWidth', 2)
grid on
set(gca,'fontsize',20)
xlabel('$N$','Interpreter','latex', 'FontSize', 30)
ylabel('Resolutions($\textup{\AA}$)','Interpreter','latex', 'FontSize', 30)
